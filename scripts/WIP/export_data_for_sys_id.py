...
import alphabuilding.config_schemas  # registers schemas (e.g. model/default_schema) with Hydra
...
def main(cfg: DictConfig) -> None:
    output_path = Path(paths.data_dir) / "system_id_data.mat"
    ...
    print(f"Data exported to MATLAB format at: {output_path}")
